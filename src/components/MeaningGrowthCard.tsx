    ...
    return (
      <section className="mt-4 rounded-2xl border border-amber-100 bg-amber-50 p-5">
        ...
        <div className="mt-4 rounded-xl bg-white p-4">
          <p className="break-keep leading-7 text-gray-700">
            아직 비교할 기록의 변화가
            없습니다.
          </p>
      ...
      {!growth.hasMeaningGrowth ? (
        ...
        <>
          <div className="mt-4 rounded-xl bg-white p-4">
            ...
            <p className="mt-4 break-keep leading-7 text-gray-700">
              {growth.summary}
            </p>
          </div>

          {growth.addedMeanings.length >
            0 && (
            <div className="mt-4 rounded-xl bg-white p-4">
              ...
              <ul className="mt-3 space-y-2">
                {growth.addedMeanings.map(
                  (
                    ...
                    <li
                      key={`${meaning}-${index}`}
                      className="flex gap-2 break-keep leading-6 text-gray-700"
                    >
                      <span
                        aria-hidden="true"
              ...
              <div className="mt-3 space-y-3">
                {growth.evidence.map(
                  (
                    ...
                    <blockquote
                      key={`${evidence}-${index}`}
                      className="break-keep border-l-2 border-amber-300 pl-3 leading-6 text-gray-600"
                    >
                      {evidence}
                    </blockquote>
                  )
          ...
          <p className="mt-4 break-keep text-xs leading-5 text-gray-500">
            이 내용은 사용자를
            평가하거나 정의하는 결과가
            아니라, 최초 기록과 최신
            기록 사이에서 새롭게 드러난
